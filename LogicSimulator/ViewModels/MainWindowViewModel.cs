...
namespace LogicSimulator.ViewModels {
    ...
    { 
        ...
        static bool first = true; // первая запись в файл

        static readonly bool use_file = false; // нужна запись в файл
    ...
    public class MainWindowViewModel: ViewModelBase {
        ...
        { 
            ...
            panel.PointerPressed += (object? sender, PointerPressedEventArgs e) => {  // обработчики событий нажатия, перемещения и отпускания кнопки мыши на Canvas
            ...
            panel.PointerReleased += (object? sender, PointerReleasedEventArgs e) => { 
                ...
                { 
                    ...
                    if (tap && mode == 1) { //если холст нажат
                        var pos = map.tap_pos;
                        if (canv == null) return; // возвращаем управление
        ...
        Grid? cur_grid; //текущий грид
        TextBlock? old_b_child; //предыдущий текстблока
        object? old_b_child_tag; //его тэг
        string? prev_scheme_name; //прошлое название схемы
        ...
        public void Update() { 
            ...
            // RaisePropertyChanged сообщает интерфейсу об обновлении свойств
